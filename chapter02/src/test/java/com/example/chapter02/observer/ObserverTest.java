...
public class ObserverTest {
   ...
   public void observersHandleEventsFromSubjectWithAssertions() {
      ...
      Observer<String> observerA = Mockito.spy(new ConcreteObserverA()); // 관찰자 A
      Observer<String> observerB = Mockito.spy(new ConcreteObserverB()); // 관찰자 B
      ...
      // then
      Mockito.verify(observerA, times(1)) // 호출 횟수
